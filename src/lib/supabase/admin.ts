...
if (supabaseUrl && supabaseServiceRoleKey) {
  ...
  console.warn('Supabase admin client could not be initialized. Make sure NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY are set in your environment variables.');
}
